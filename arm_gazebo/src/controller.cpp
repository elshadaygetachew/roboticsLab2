...
namespace gazebo
{
  class Controller1 : public ModelPlugin
  {
    ...
    private: void updateJointAnglesCallback(const arm_gazebo::JointAngles& msg)
    {
    ...
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
        ...
        this->jointPublisher = this->nodeHandle.advertise<arm_gazebo::JointAngles>("jointangles", 10);
